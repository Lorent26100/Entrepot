/****** Object:  View [dbo].[v_BI_Dim_Fournisseurs]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE   VIEW [dbo].[v_BI_Dim_Fournisseurs] AS SELECT
...
F057CPTA_typ_2.K057306ANA AS Analytique, 
...
F057CPTA_typ_2.K057320RGL AS Mode_de_reglement, 
F057CPTA_typ_2.F057ECH AS Echeance, 
...
FROM
 F050TIERS INNER JOIN  (
  ...
  FROM
   F05ZTYPE
  WHERE
  F05ZTYPE.K05ZT05TYP = '2'
 ) Liens_types_tiers_2 ON(  Liens_types_tiers_2.K05Z050TIE = F050TIERS.F050KY )
 ...
 LEFT OUTER JOIN  (
  ...
  FROM
   F057CPTA
  WHERE
  F057CPTA.K057T05TYP = '2'
  AND  F057CPTA.F057ORDRE = 0
 ) F057CPTA_typ_2 ON(  F057CPTA_typ_2.K057050KY = F050TIERS.F050KY )
 LEFT OUTER JOIN  (
  SELECT
